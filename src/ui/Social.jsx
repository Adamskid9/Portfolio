...
function Social({num,style}) {
    return (<>
        {num===1&&<li className="border-[1px] border-black list-none p-1 cursor-pointer hover:bg-blue-200">
           <a href="discordapp.com/users/1025085120719356024"><img src={"/social/discord.png"} className="h-[30px] w-[30px]" alt=""/></a>
        </li>}
        {num===2&&<li className="border-[1px] border-black p-1 list-none cursor-pointer hover:bg-blue-200">
           <a href="https://x.com/Ajaniadam1?t=I0Ze6Ll-B-rfEPIqgTQgpg&s=09"><img src={"/social/x.png"} className="h-[30px] w-[30px]" alt=""/></a>
        </li>}
        {num===3&&<li className="border-[1px] border-black p-1 list-none cursor-pointer hover:bg-blue-200">
           <a href="https://github.com/Adamskid9"><img src={"/social/github.png"} className="h-[30px] w-[30px]" alt=""/></a> 
        </li>}
        {num===4&&<li className="border-[1px] border-black list-none p-1 cursor-pointer hover:bg-blue-200">
        ...
        {num===5&&<li className="border-[1px] border-black p-1 cursor-pointer hover:bg-blue-200">
            <IoLogoFacebook className={`${style}`}/>
        </li>}
        {num===6&&<li className="border-[1px] border-black p-1 cursor-pointer hover:bg-blue-200">
            <IoLogoHtml5 className={`${style}`}/>
        </li>}
        {num===7&&<li className="border-[1px] border-black p-1 cursor-pointer hover:bg-blue-200">
            <IoLogoJavascript className={`${style}`}/>
        </li>}
        {num===8&&<li className="border-[1px] border-black p-1 cursor-pointer hover:bg-blue-200">
            <IoLogoReact className={`${style}`}/>
        </li>}
        {num===9&&<li className="border-[1px] border-black p-1 cursor-pointer hover:bg-blue-200">
